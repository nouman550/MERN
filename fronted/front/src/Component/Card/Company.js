...
const Company = () => {
    ...
    const handleChange = (event) => {
        if (event.target.name === "avatar"||event.target.name === "companyAvatar" ) {
            ...
            else if(event.target.name === "companyAvatar"){
                const reader = new FileReader();
                reader.onload = () => {
                    if (reader.readyState === 2) {
                        setFormValues({ ...formValues ,companyAvatar: reader.result});
                    }
                }
    ...
    return (
        ...
        <Fragment>
            ...
            {visibleForm ? (<div className="personal-div" >
                ...
                <p > Doouble Sided Card...... Company Card</p>
                ...
                <form encType="multipart/form-data" onSubmit={handleSubmit} >
                    ...
                    <div className="company-product">
                        ...
                        <input
                            ...
                            value={formValues.companyProduct}
                            onChange={handleChange}
                        />
                    </div>
                    <label className="user-label">User Profile</label>
                    <input

                        className="company-user-profile-div"
                        type="file"
                        name="avatar"
                    ...
                    <label className="company-label">Company Logo</label>
                    <input

                        className="company-logo-profile-div"
                        type="file"
                        name="companyAvatar"
                        placeholder="choose profile picture"
                        accept="image/*"
                    ...
                    <Button className="company-btn-input-card" type="submit" endIcon={<SendIcon className="buton-icon" />}   > Create Card</Button>
                </form>
                ...
                <DoubleSidedCard data={formValues} />
            )}
